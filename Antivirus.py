        ...
        try:
            ...
            if self.UseMetaDefenderApiCheckBox.isChecked():
                ...
                if MetaDefenderApiKey == "":
                    ...
                    msgBox.setIcon(QtWidgets.QMessageBox.Critical)
                    msgBox.setText("Error")
                    msgBox.setInformativeText(f"""\Please enter a valid Meta Defender API key.""")
                    # remove window title bar
                    msgBox.setWindowFlags(QtCore.Qt.WindowStaysOnTopHint)
                    msgBox.setWindowFlags(QtCore.Qt.FramelessWindowHint)
                    msgBox.exec_()
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, qt_material=None):
        ...
        self.HomeTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.VirusTotalApiKey.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.VirusTotalApiKey.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.MetaDefenderApiKey.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.MetaDefenderApiKey.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.VirusResultsTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.IsFileVirusY_N.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_3.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter | QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.DetectionsText.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_5.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter | QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.label_4.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter | QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.MetaDefenderDetectionsText.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_6.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter | QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.LoadingPageTitle.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", f"-AntiVirus- [dev: {DEV}]"))
